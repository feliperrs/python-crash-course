...
#? Crie uma lista de suas frutas favoritas e, em seguida, escreva uma série de declarações if independentes que verificam determinadas frutas em sua lista.
...
favorite_fruits = ['kiwi', 'morango', 'framboesa']
...
if 'framboesa' in favorite_fruits:
    print('Você realmente gosta de framboesa')
